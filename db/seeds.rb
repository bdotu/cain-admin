...
expense_acts = [
  {gross_amount: -200, payment_type: "cash", item_description: "Library Building", issuing_person: "Daisy", receiving_person: "Nigerian Tax", location: "Nigeria", receipt_received_or_issued: "7-22-2016", platform: "Bank-UBA", comments: ":D"},
  {gross_amount: 600, payment_type: "check", item_description: "School Construction", issuing_person: "Bright", receiving_person: "IRS", location: "USA", receipt_received_or_issued: "4-20-2016", platform: "Bank-UBA", comments: "amount submitted"}
]
